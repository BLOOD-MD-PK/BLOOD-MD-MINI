...
// ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝   ╚═══╝    ╚═╝     ╚═╝╚═════╝ 
// ═══════════════════════════════════════════════════════════════════════════
//                    BLOOD-CO - BOT CONFIGURATION
// ═══════════════════════════════════════════════════════════════════════════

// ============================================
// 🔥 BLOOD-MD MINI - COMPLETE SETTINGS
// 👑 Developer: ʙʟᴏᴏᴅ-ᴄᴏ
...
module.exports = {
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʙʟᴏᴏᴅ-ᴄᴏ',
     ...
     * @type {string}
     */
    CHANNEL_JID: process.env.CHANNEL_JID || '120363410830712574@newsletter',
     ...
     * @type {string}
     */
    IMAGE_PATH: process.env.IMAGE_PATH || 'https://files.catbox.moe/5c2xf1.png',

    /**
     * @description WhatsApp channel link for updates
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb867uIKwqSWDtOS2X3N',
     ...
     * @type {string}
     */
    OWNER_LINK: process.env.OWNER_LINK || 'https://wa.me/923188871441',
...
/**
 * @module settings
 * @description BLOOD-MD MINI Configuration Module
 * @version 2.0.0
 * @author ʙʟᴏᴏᴅ-ᴄᴏ
 * @license MIT
 */
